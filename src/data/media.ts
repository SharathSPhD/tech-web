...
export const reads: { outlet: string; kicker: string; href: string; items: Article[] }[] = [
  ...
  {
    outlet: 'Engineering blog',
    kicker: 'sharathsphd.github.io',
    href: 'https://sharathsphd.github.io',
    items: [
      {
        title: "ChatGPT and a Hike to Saturn's Moon",
        href: 'https://sharathsphd.github.io/blog/2024/03/25/chatgpt-and-hike-to-saturn/',
      },
      {
        title: 'Enigma & Entropy: Transforming Engineering & Shaping Tomorrow',
        href: 'https://sharathsphd.github.io/blog/2024/02/15/enigma-entropy/',
      },
      {
        title: 'Rivers of Thought: Beyond Generative AI',
        href: 'https://sharathsphd.github.io/blog/2024/02/08/rivers-of-thought/',
      },
      {
        title: 'Publications',
        href: 'https://sharathsphd.github.io/blog/2024/02/08/publications/',
      },
    ],
  },
];
